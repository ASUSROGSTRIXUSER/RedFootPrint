<?php
    ...
    if(isset($_POST['btn_add']))
    {
      ...
      $email     = $_POST['email'];      
      $con = mysqli_query($conn, "SELECT * FROM wp_affiliate WHERE affiliate_email = '$email'");
    
      if(mysqli_num_rows($con) == 0)
      {
        
          $insert = mysqli_query($conn, "INSERT INTO wp_affiliate VALUES('','$date_created','$id','$fname','$mname','$lname','$bdate','$contactnumber','$email','$address','$password','$status',' ')") or die(mysqli_error());
         if($insert)
          {
              /*
            ...
            $success = "success";
            echo "<script>document.location='affiliate_login.php'</script>";
          }
          else
          {
                                        ...
                                        <div class="block-content row text-muted">
                                            <div class="col-md-12">
                                                ...
                                                { ?>     
                                                    ...
                                                    <div class="alert alert-success alert-dismissable" role="alert">
                                                        ...
                                                        <p class="mb-0">Account created successfully, you can now sign in to our Affiliate area.</p>
                                                    </div>
                                                    <!-- END Success Alert -->                 
                                                <?php }
                                                ?>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <label for="firstname">First Name</label><span class="text-danger"> (required)</span>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <label for="lastname">Last Name</label><span class="text-danger"> (required)</span>
                                                        <input type="text" class="form-control" name="lname" required>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <label for="birthdate">Birthdate</label><span class="text-danger"> (required)</span>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <label for="contact">Contact Number</label><span class="text-danger"> (required)</span>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <label for="password_entry">Password</label><span class="text-danger"> (required)</span>
                                                        <input type="password" class="form-control" name="password" required>
                                                    </div>
                                                </div>   
                                                <div class="form-group row">
                                                    <div class="col-12">
                                                        <label for="confirmpassword_entry">Confirm Password</label><span class="text-danger"> (required)</span>
                                                ...
                                                <div class="col-md-6 ">
                                                        <p class="text-muted">
                                                            ...
                                                            * 1 numeric (0-9)<br>
                                                            * 1 lowercase case (a-z)<br>
                                                            * 1 uppercase case (A-Z)
                                                        </p>
                                                    </div>                                      
                                                    </div>
                                                </div>
