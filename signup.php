<?php
    ...
    if(isset($_POST['btn_add']))
    {
      ...
      {
          $insert = mysqli_query($conn, "INSERT INTO wp_member VALUES('','','$fname','$mname','$lname','$bdate','$address','$contact_number','$email','$username','$password','$type','','$real_password')") or die(mysqli_error());
          if($insert)
          {
                                    ...
                                    <div class="block block-themed block-rounded block-shadow shadow">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group row">
                                                            <div class="col-12">
                                                                <label for="login-username">Confirm</label><span class="text-danger"> (require)</span>
                                        ...
                                        <div class="block-content bg-body-light">
                                            <div class="form-group text-center row">
                                                ...
                                                <div class="col-sm-4">
                                                    <a class="btn btn-sm btn-hero btn-noborder btn-alt-danger btn-block mb-5" href="index.php">
                                                        <i class="si si-login mr-5"></i> Sign In
                                                    </a>
                                                </div>
                                                <div class="col-sm-4">
                                                    <a class="btn btn-sm btn-hero btn-noborder btn-alt-danger btn-block mb-5" href="forgot_password.php">
